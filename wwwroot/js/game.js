...
const TITLES = [
    ...
    { id:'silver_t',     label:'Scribe',            tier:'silver',       req:{ type:'points', value:1000, display:'Reach Silver'      } },
    { id:'gold_t',       label:'Linguist',          tier:'gold',         req:{ type:'points', value:2000, display:'Reach Gold'        } },
    { id:'platinum_t',   label:'Lexical Knight',    tier:'platinum',     req:{ type:'points', value:3000, display:'Reach Platinum'    } },
    { id:'diamond_t',    label:'Wordsmith',         tier:'diamond',      req:{ type:'points', value:4000, display:'Reach Diamond'     } },
    { id:'champion_t',   label:'Word Virtuoso',     tier:'champion',     req:{ type:'points', value:5000, display:'Reach Champion'    } },
    { id:'master_t',     label:'Lexical Titan',     tier:'master',       req:{ type:'points', value:6000, display:'Reach Master'      } },
    { id:'gm_t',         label:'Word Oracle',       tier:'grandmaster',  req:{ type:'points', value:7000, display:'Reach Grandmaster' } },
    { id:'lexicongod_t', label:'The Word Incarnate',tier:'lexicongod',   req:{ type:'points', value:8000, display:'Reach Lexicon God' } },
