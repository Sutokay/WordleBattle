...
const BORDERS = [
    ...
    { id:'champion',    label:'Champion',    cls:'avatar-border-champion',   color:'#C77DFF', req:{ type:'points', value:5000, display:'Reach Champion (5000 pts)'} },
    { id:'master',      label:'Master',      cls:'avatar-border-master',     color:'#FF4500', req:{ type:'points', value:6000, display:'Reach Master (6000 pts)'  } },
    { id:'grandmaster', label:'Grandmaster', cls:'avatar-border-grandmaster',color:'#FF3C6E', req:{ type:'points', value:7000, display:'Reach Grandmaster (7000 pts)'} },
    { id:'lexicongod',  label:'Lexicon God', cls:'avatar-border-lexicongod', color:'#FFFDE7', req:{ type:'points', value:8000, display:'Reach Lexicon God (8000 pts)'} },
...
const TITLES = [
    ...
    { id:'silver_t',     label:'Page Wanderer',     tier:'silver',       req:{ type:'points', value:1000, display:'Reach Silver'      } },
    { id:'gold_t',       label:'Phrase Seeker',     tier:'gold',         req:{ type:'points', value:2000, display:'Reach Gold'        } },
    { id:'platinum_t',   label:'Puzzle Weaver',     tier:'platinum',     req:{ type:'points', value:3000, display:'Reach Platinum'    } },
    { id:'diamond_t',    label:'Word Decrypter',    tier:'diamond',      req:{ type:'points', value:4000, display:'Reach Diamond'     } },
    { id:'champion_t',   label:'Pattern Finder',    tier:'champion',     req:{ type:'points', value:5000, display:'Reach Champion'    } },
    { id:'master_t',     label:'The Fluent',        tier:'master',       req:{ type:'points', value:6000, display:'Reach Master'      } },
    { id:'gm_t',         label:'The Unscrambler',   tier:'grandmaster',  req:{ type:'points', value:7000, display:'Reach Grandmaster' } },
    { id:'lexicongod_t', label:'The Divine Word',   tier:'lexicongod',   req:{ type:'points', value:8000, display:'Reach Lexicon God' } },
